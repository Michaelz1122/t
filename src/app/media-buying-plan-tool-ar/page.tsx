...
#خطة_إعلانية #تسويق #إعلانات`
  ...
  const generateChannelSelection = () => {
    ...
    return `📺 **اختيار القنوات الإعلانية**

### 🎯 **تحليل القنوات المناسبة لـ ${industryText}:**

#### **القنوات الرقمية (موصى بها بشدة)**

**1. منصات التواصل الاجتماعي (40% من الميزانية)**
**فيسبوك وإنستجرام:**
• الجمهور: 25-45 سنة، متنوع الثقافات
• الميزة: استهداف دقيق جداً
• التكلفة: 1-3 ج.م للنقرة
